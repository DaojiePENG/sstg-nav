...
class MinimalService(Node):
    ...
    def add_three_ints_callback(self, request, response):
        ...
        map_path = "/home/jetson/sstg_nav/yahboomcar_ws/src/yahboomcar_nav/maps/" + map_name
        ...
        try:
            conn = sqlite3.connect("/home/jetson/sstg_nav/yahboomcar_ws/src/yahboom_app_save_map/yahboom_app_save_map/xgo.db")
            c = conn.cursor()
